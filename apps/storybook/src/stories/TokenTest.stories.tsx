...
function TokenTest() {
  return (
    <div className="bg-ds2-surface p-ds2-m rounded-ds2-l">
      <h1 className="ds2-display-lg">Indigo Design System</h1>
      <p className="ds2-body-md text-ds2-subtle">Tokens and Tailwind are working.</p>
      <button className="bg-ds2-danger-bold text-ds2-inverted text-ds2-button px-ds2-s py-ds2-xxs rounded-ds2-m mt-ds2-s">
        Primary Button
      </button>
    </div>
  )
