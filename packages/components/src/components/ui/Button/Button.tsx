  ...
  "group/button inline-flex shrink-0 items-center justify-center ds2-button rounded-ds2-m border border-transparent bg-clip-padding whitespace-nowrap transition-all outline-none select-none focus-visible:border-ds2-focused focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:bg-ds2-disabled disabled:text-ds2-disabled [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-ds2-neutral text-ds2-default hover:bg-ds2-neutral-hover active:bg-ds2-neutral-pressed aria-expanded:bg-ds2-selected aria-expanded:text-ds2-selected aria-expanded:border-ds2-selected",
        tertiary:
          "bg-ds2-neutral-subtle text-ds2-subtle hover:bg-ds2-neutral-subtle-hover active:bg-ds2-neutral-subtle-pressed aria-expanded:bg-ds2-selected aria-expanded:text-ds2-selected aria-expanded:border-ds2-selected",
        destructive:
        ...
        link: "text-ds2-link disabled:bg-ds2-neutral-subtle hover:text-ds2-link-pressed underline-offset-4 hover:underline",
      },
      size: {
        // Regular buttons
